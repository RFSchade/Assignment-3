...
pacman::p_load(readr,dplyr,stringr,lmerTest,Metrics,caret,knitr,tidyverse)
...
lu2 <- read.csv("LU_test2.csv")
demo2 <- read.csv("demo_test2.csv")
token2 <- read.csv("token_test2.csv")

#-----> recreate the models you chose last time (just write the code again and apply it to Train Data)
m1 <- lmer(CHI_MLU ~ VISIT * Diagnosis + ExpressiveLangRaw1 + MOT_MLU + (1|SUBJ) + (0+VISIT|SUBJ), data)
summary(m1)
...
predictions <- predict(m1, data)
# Calculating RMSE
rmse(data$CHI_MLU, predictions)
# Apperently the Root mean square error of the model is 0.3509159 - I don't really know how to interpret this. 
